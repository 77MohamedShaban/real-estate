...
const buttonVariants = cva(
  "flex items-center justify-center disabled:px-5 rounded-md font-medium disabled:text-white duration-300 dark:text-black disabled:bg-indigo-900 disabled:hover:bg-indigo-900 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        // ** FILLED
...
const Button = ({
  ...
  return (
    <button type={type} className={buttonClass} {...props} disabled={isLoading}>
      {isLoading ? (
        <svg
